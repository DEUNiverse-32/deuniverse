...
export default function DeuniverseDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f1eb] text-zinc-400 p-8 selection:bg-zinc-900 selection:text-zinc-200">
      <div className="max-w-xl mx-auto">
        ...
        <header className="mb-12 border-l border-zinc-300 pl-6">
          <h1 className="text-xl font-bold text-zinc-900 mb-3 tracking-tight">
            {post.title}
          </h1>
        ...
        <footer className="mt-32 mb-10 text-center">
          <p className="text-zinc-500 text-[9px] font-mono tracking-widest leading-loose uppercase">
