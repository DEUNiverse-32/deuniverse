...
export default function ProfileDetailPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#a8afb7] text-[#111827] p-8 selection:bg-[#5f6b78] selection:text-slate-950 font-mono">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative border border-[#4f5863] bg-[#8f98a3]/35 backdrop-blur-2xl p-8 md:p-14 shadow-[0_0_28px_rgba(0,0,0,0.10)] overflow-hidden">
          ...
          <div className="relative z-10 animate-in fade-in duration-1000">
            ...
            {/* 상단 프로필 사진 및 이름 영역 */}
            <div className="flex flex-col md:flex-row gap-12 items-start mb-16 border-b border-[#4f5863]/40 pb-12">
              <div className="relative flex-shrink-0">
                <div 
                  className="w-44 h-56 md:w-52 md:h-64 relative border-2 border-[#4f5863] bg-[#6b7280]/30 cursor-pointer overflow-hidden"
              ...
              <div className="flex-1 w-full pt-4">
                <h2 className="text-[11px] tracking-[0.6em] text-[#7a4b4b] font-bold mb-4 uppercase">
                  Subject Identification
                </h2>
                <h3 className="text-4xl md:text-6xl font-extrabold tracking-[-0.06em] uppercase text-[#cfd5dc] mb-10">
                  {userInfo.name}
                </h3>
                <div className="inline-flex flex-col border-l-4 border-[#7a4b4b] pl-6">
                  <span className="text-[10px] text-[#5f6b78] tracking-[0.4em] uppercase mb-1 font-bold">Clearance Level</span>
                  <span className="text-lg text-[#7a4b4b] font-bold tracking-[0.2em] uppercase">{userInfo.clearance}</span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-14 pt-8 border-t border-[#4f5863]/40 flex justify-between items-center">
              ...
              <span className="text-[10px] text-[#5f6b78] tracking-[0.6em] uppercase font-bold">
